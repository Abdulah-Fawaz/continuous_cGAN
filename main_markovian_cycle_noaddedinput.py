...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 10 12:38:54 2022
...
from markovian_models import GraphNet_Markovian_Generator_noaddedinput, GraphNet_Markovian_Discriminator, GraphNet_Markovian_Discriminator_Simple
...
model = GraphNet_Markovian_Generator_noaddedinput(len(mode), age_dim = 1,device=device)
...
torch.save(model, '/home/fa19/Documents/neurips/3cycle_nai_generator_model_final')
        
torch.save(discriminator, '/home/fa19/Documents/neurips/3cycle_nai_discriminator_model_final')
        
torch.save(model.state_dict(), '/home/fa19/Documents/neurips/3cycle_nai_generator_model_final_sd')
        
torch.save(discriminator.state_dict(), '/home/fa19/Documents/neurips/3cycle_nai_discriminator_model_final_sd')
...
for num in np.arange(32,45):
    ...
    save_as_metric(im1_np[0], '3cycle_nai/test_triple/val_original'+'_'+str(true_age_1[0].item())+'_'+str(name))
    
    save_as_metric(im2[0], '3cycle_nai/test_triple/val_fake'+'_'+str(new_age[0].item())+'_'+str(name))
...
save_as_metric(im2_np[0], '3cycle_nai/test_triple/val_original_secondscan'+'_'+str(true_age_2[0].item())+'_'+str(name))
