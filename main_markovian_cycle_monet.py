...
for epoch in range(num_epochs):
    ...
    if epoch % 50 == 0:
        model.eval()
        discriminator.eval()
        torch.save(model, '/home/fa19/Documents/neurips/MoNet_3cycle_all_generator_model_final')
                
        torch.save(discriminator, '/home/fa19/Documents/neurips/MoNet_3cycle_all_discriminator_model_final')
                
        torch.save(model.state_dict(), '/home/fa19/Documents/neurips/MoNet_3cycle_all_generator_model_final_sd')
                
        torch.save(discriminator.state_dict(), '/home/fa19/Documents/neurips/MoNet_3cycle_all_discriminator_model_final_sd')
...
for idxs in all_shared:
    ...
    for num in np.arange(32,45):
        ...
        save_as_metric(im1_np[0], '3cycle_MoNet/test_triple/val_original'+'_'+str(true_age_1[0].item())+'_'+str(name))
        
        save_as_metric(im2[0], '3cycle_MoNet/test_triple/val_fake'+'_'+str(new_age[0].item())+'_'+str(name))
    ...
    save_as_metric(im2_np[0], '3cycle_MoNet/test_triple/val_original_secondscan'+'_'+str(true_age_2[0].item())+'_'+str(name))
