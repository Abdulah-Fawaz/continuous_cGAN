...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(train_loader):
        ...
        im1_recon_loss = recon_loss(im5, im1)  * 5
        ...
        gloss = im1_recon_loss + im2_real_loss + im3_real_loss + im4_real_loss
        ...
        if i % d_update_freq==0 :
            ...
            d_loss = real_image_true  + fake_gloss1 + fake_gloss2 + fake_gloss3 + fake_rloss1 + fake_rloss2 + fake_rloss3
...
torch.save(model, '/home/fa19/Documents/neurips/4cycle_double_generator_model_final')
        
torch.save(discriminator, '/home/fa19/Documents/neurips/4cycle_double_discriminator_model_final')
        
torch.save(model.state_dict(), '/home/fa19/Documents/neurips/4cycle_double_generator_model_final_sd')
        
torch.save(discriminator.state_dict(), '/home/fa19/Documents/neurips/4cycle_double_discriminator_model_final_sd')
        
# model = torch.load('/home/fa19/Documents/neurips/3cycle_generator_model_final')
...
for idxs in all_shared:
    ...
    for num in np.arange(32,45):
        ...
        save_as_metric(im1_np[0], '4cycle/test/val_original'+'_'+str(true_age_1[0].item())+'_'+str(name))
        
        save_as_metric(im2[0], '4cycle/test/val_fake'+'_'+str(new_age[0].item())+'_'+str(name))
