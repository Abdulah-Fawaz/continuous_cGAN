...
# -*- coding: utf-8 -*-
"""
Created on Tue May  2 10:41:43 2023
...
from data_utils.MyDataLoader import My_dHCP_Data_Graph, My_dmri_Data_Graph
...
train_dataset_arr = np.load('data/' + str(dataset) + '/train2.npy', allow_pickle = True).astype(object)
val_dataset_arr = np.load('data/' + str(dataset) + '/val2.npy', allow_pickle = True).astype(object)
test_dataset_arr = np.load('data/' + str(dataset) + '/test2.npy', allow_pickle = True).astype(object)
...
torch.save(model,'/home/fa19/Documents/neurips/dmri2/dmri_regressor_monet_ba_std')

torch.save(model.state_dict(),'/home/fa19/Documents/neurips/dmri2/dmri_regressor_monet_ba_std_sd')
